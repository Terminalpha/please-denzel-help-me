...
const family = {'married':1983,'presidentOfTheUnitedStates':false, 'children':['John David','Katia','Olivia','Malcom']};
// Q4. Change
...
const earlywork = { "Carbon Copy":1981,"A Soldier Story":1984,"Power":1986,"Cry Freedom":1987,"For Queen and Countryy":1988};
...
const debatersUpper = debaters.map(a =>a.toUpperCase());
// Q8. Using this array.
...
const duplicate = array =>{ array.map(a=>array.push(a)); return array;}
...
// return a json on actor informations

// Q14. Refactor the following codebase with a promise notation
const Promise14 = new Promise((filePath)=>{})
...
//"https://www.dota2.com/home", "https://na.leagueoflegends.com/fr-fr/","https://store.steampowered.com/"
// Q17. Describe an ESILV project that you worked on that you’re proud of?

// my Pi2 of the year on Human Body comparaison by using Openpose 
// Q18. Describe an ESILV project that you worked on that you’re not so proud of?
// a application on the environnement that what not entirely finish like we wanted in ping project
// Q19. What are some things you like about the developer tools you use?
// the ergonomy and the easy way to navigate mmore than in a cmd environemment ,i work a lot with docker so phpmyadmin for example
...
// because of two points : first there is not a absolute way to architect of web application and there is different part in code ( server ,client) in the page with html/css, hhtp request 
